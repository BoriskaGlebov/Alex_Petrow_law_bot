...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "photos", "applications", ["application_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("videos_application_id_fkey", "videos", type_="foreignkey")
    op.create_foreign_key(
        None, "videos", "applications", ["application_id"], ["id"], ondelete="CASCADE"
    )
